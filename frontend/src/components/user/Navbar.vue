<template>
  <div class="sticky top-0 z-50">
    <header class="bg-blue-600 text-white py-2 shadow-md font-sans">
...
=======
          <router-link to="/" class="text-2xl font-extrabold tracking-tighter flex items-center italic">
>>>>>>> dee0a08f1534b5e9f236321669ff6fdec3f13fa0
            Sahafa<span class="text-yellow-400"></span>
          </router-link>

          <div class="relative group z-50">
            <div class="flex items-center justify-center cursor-pointer hover:bg-blue-700 w-10 h-10 rounded-lg transition p-2 border-2 border-transparent hover:border-blue-400">
        ...
        <div class="flex-grow-0 w-full md:w-[420px] lg:w-[520px] mx-auto relative group/search">
          <div class="bg-white rounded-xl flex items-center p-1 shadow-lg overflow-hidden">
            <input 
              v-model="searchQuery" 
              ...
              class="w-full px-3 py-1 text-gray-800 outline-none text-sm font-medium placeholder:text-gray-400" 
            />
            
            <button @click="goToSearchPage" class="bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded-lg font-bold transition flex items-center justify-center shrink-0">
        ...
        <div class="flex items-center gap-8 shrink-0">
            ...
            <div class="relative group z-50 cursor-pointer hover:text-yellow-300 text-white transition flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
          </div>

          <router-link to="/cart" class="relative cursor-pointer hover:text-yellow-300 text-white transition flex items-center">
            ...
            <div class="relative group z-50">
            <div @click="!authStore.user ? openModal('login') : null" class="cursor-pointer hover:text-yellow-300 text-white transition flex items-center">
